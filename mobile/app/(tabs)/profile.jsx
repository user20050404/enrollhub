...
export default function Profile() {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      // ✅ TEMP DEBUG
      console.log('Fresh user:', JSON.stringify(fresh.data))
  ...
  // ✅ Immediate fallback to local picked image
  const profileImage = imageUri || user?.profile_image || null
    ...
    <SafeAreaView style={s.safe}>
      <ScrollView contentContainerStyle={s.content}>
        ...
        <View style={s.actionRow}>
          ...
          >
            <Text style={[s.actionBtnText, { color:'#818CF8' }]}>
              🔒 Change Password
            </Text>
          </TouchableOpacity>
        </View>
          ...
          <View style={ms.overlay}>
            <View style={ms.sheet}>
              ...
              <View style={ms.avatarRow}>
                ...
                {imageUri ? (
                  ...
                  <View style={ms.previewInitials}>
                    <Text style={ms.previewInitialsText}>
                      {initials}
                    </Text>
                  </View>
                )}
                ...
                <TouchableOpacity
                  style={ms.changePhotoBtn}
                  onPress={handlePickImage}
                >
                  <Text style={ms.changePhotoText}>
                    📷 Change Photo
                  </Text>
                </TouchableOpacity>
              ...
              <TouchableOpacity
                style={[
                  ms.saveBtn,
                  savingProfile && ms.saveBtnDisabled
                ]}
            ...
            <View style={ms.sheet}>
              ...
              >
                {savingPw ? (
                  ...
                  <Text style={[ms.saveBtnText, { color:'#FFF' }]}>
                    Change Password
                  </Text>
                )}
              </TouchableOpacity>
